 ...
 */
package de.hanbei.liblda.inference;
...
public interface InferenceEngine extends Serializable {
    ...
    /**
     * Set the {@link de.hanbei.liblda.RandomEngine} to sample topics. The standard random engine should is an
     * engine that uses {@link java.util.Random}.
     *
     * @param random The {@link de.hanbei.liblda.RandomEngine} to sample topics
     */
    ...
    /**
     * Train the topic model. The training data is supplied as a List of {@link de.hanbei.liblda.datastructures.DocumentData}.
     *
